...
def d_calculate(a, b, c):
    ...
    if d < 0:
        ...
        d_desc = u'Дискриминант равен нулю, квадратное уравнение имеет один действительный корень: x1 = x2 = %s' % round(x1, 1)
    else:
        d_desc = u'Квадратное уравнение имеет два действительных корня: x1 = %s, x2 = %s' % (round(x1, 1), round(x2, 1))
